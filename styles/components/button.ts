...
export const Button: ComponentStyleConfig = {
  ...
  variants: {
    primary: (props: any) => ({
      ...
      _hover: { bg: mode('thia.purple.100', 'thia.purple.600')(props), borderRadius: 'xl' },
    ...
    primaryOutline: (props: any) => ({
      ...
      _hover: { bg: mode('thia.purple.50', 'thia.purple.900')(props), borderRadius: 'xl' },
    ...
    secondary: (props: any) => ({
      ...
      _hover: { bg: mode('blackAlpha.200', 'whiteAlpha.200')(props), borderRadius: 'xl' },
