    ...
    return (
        <AuthTemplatePage heading='Join Thia today' text='Sign up to start training'>
            <VStack spacing={6} py={1} w='full'>
                <FormControl isRequired isInvalid={userRegistrationFocusedOnce.fullName && userRegistrationErrorMessages.fullName != ''}>
                ...
                <FormControl isRequired isInvalid={userRegistrationFocusedOnce.password && userRegistrationErrorMessages.password != ''}>
