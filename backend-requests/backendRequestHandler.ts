...
import {
    PostNewCreditCardBackendRequest,
    PostNewCreditCardData,
} from './requests/post/saveNewCreditCard';
import {
    PostNewUserClaimsBackendRequest,
    PostNewUserClaimsData,
} from './requests/post/setNewUserRoles';
...
export class BackendRequestHandler {
    ...
    public saveNewCreditCard = async (
        idToken: string,
        data: PostNewCreditCardData,
        config?: AxiosRequestConfig
    ) => {
