...
coverImage:
    url: /blog/our-origins/chapter_1.jpg
    alt: Chapter 1
    title: Chapter 1
    width: 1200
    height: 630
...
Unlike Zapier, which came [directly][1] from a hackathon the three founders attended, I
...
acquired a newfound passion. In addition to the many projects I completed using my new knowledge, I worked with machine learning in
both the industry, and in research for over a year. At this point I was thinking that my career was going to result in machine
...
in stealth mode is not considered to be a [good][3] decision. However, in this case I wasn't operating in stealth mode because I was afraid someone
...
-   _Proof of Technology_ finished September 2021 while working full-time as an SWE Intern.
-   No development was done between September to December 2021 due to taking a heavy course load and working part-time in research.
-   Resumed development in January 2022 with a lighter course load, still working part-time in research.
...
and _Remote Engine_ (it allows you to use a virtual machine with a GPU instead of your own GPU — which is useful if you don't have a GPU
...
-   Get to know them more. Hang out, grab a coffee, and see if they are someone you enjoy working with. If you're already friends
...
I asked a friend of mine from high school, [Lasitha][4], if he wanted to be a co-founder (he was helping me with the website for a month
...
[1]: https://journeys.autopilotapp.com/blog/zapier-remote-work-company 'Zapier Origins'
[2]: /blog/our-origins/gcp_automl_bill.png 'Google AutoML Bill'
[3]: https://news.ycombinator.com/item?id=2223705 'Stealth Mode = Bad'
[4]: /about#lasitha 'Lasitha Amuwala'
