...
description: How to get started with Thia.
---
...
> **Note:** There may be an alert when trying to install the app after downloading it, this is normal due to
> Thia using a Regular Code Signing Certificate instead of an EV Code Signing Certificate to prototype faster.
> Cick [here][6] to learn about the difference.
> ![Smartscreen Alert][5]
...
[4]: /../download 'Download'
[5]: /docs/ui/getting-started/smartscreen_alert.jpg 'Smartscreen Alert'
[6]: https://www.ssl2buy.com/wiki/regular-code-signing-vs-ev-code-signing 'Regular Code Signing vs EV Code Signing'
