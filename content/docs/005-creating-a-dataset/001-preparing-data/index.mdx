...
description: Data gathering reccomendations and image specifications.
---

# Preparing Data

After you have [created a model][5], you need to create a dataset to train the model on. The first step is to prepare your training data.
...
[5]: /docs/creating-a-model/image-classification 'Create a Model'
