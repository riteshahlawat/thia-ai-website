...
| Extra Large | 240             | 1044         | 1x                |
    ...
    <center>
        **Table 1**: Model size comparison.
        <p style={{ fontSize: '12px' }}>*Latency was measured on an RTX 3080 in batch sizes of 16. Relative accuracy is relative to the accuracy of an `Extra Large` model when trained on the [**ImageNet**][4] dataset*</p>
    </center>
