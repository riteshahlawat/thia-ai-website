---
title: How It Works
description: Learn how the app works internally and machine requirements.
---
...
-   NVIDIA GPU (Preferrably 10 series or newer.)
-   NVIDIA Drivers version above 471.41.
...
-   NVIDIA GPU with 10 GB of video memory or more.
-   Intel / AMD CPU with 6 cores.
-   16 GB of RAM
-   10 GB of SSD free space.

[1]: /docs/how_thia_works.png 'Thia Workflow'
