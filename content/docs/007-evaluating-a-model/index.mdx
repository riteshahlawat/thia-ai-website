...
description: Learn about evaluation metrics and testing your model on your own data.
---
...
The following are the steps to a trained model using your own images on the app:

1.  Navigate to the model page for the model you wish to test.
2.  Scroll down to the `Predict` section.
    ![Prediction Section][4]
3.  Upload the images you want to test and click `Test`.
4.  Wait for the test results to complete.
    ![Prediction Result][5]
    > **Note**: This may take a minute or two as the model needs to be loaded beforehand to run the test.
...
[4]: /docs/ui/image-classification-evaluation/2.jpg 'Prediction Section'
[5]: /showcase/model_predictions.jpg 'Prediction Result'
